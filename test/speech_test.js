    ...
    describe('basics', function () {
        ...
        describe('say', function () {
            ...
            it('should generate a saying tag with a voice', function () {
                ...
                assert.equal(speech.ssml(), "<speak><voice name=\"Brian\">hi</voice></speak>");
            });
            it('should generate a saying tag with a lang', function () {
                speech.say("hi", {
                    lang: "pt-BR"
                });
                assert.equal(speech.ssml(), "<speak><lang xml:lang=\"pt-BR\">hi</lang></speak>");
            });
            it('should generate a saying tag with a voice and lang', function () {
                ...
                assert.equal(speech.ssml(), "<speak><voice name=\"Brian\"><lang xml:lang=\"en-US\">hi</lang></voice></speak>");
            });
        });
